...
% - mathshape=sf to use sans serif font for math (this is missing some font families),
% - mathsahpe=custom to not set any math font (so that you can define your own math fonts)
\usetheme[engine=lualatex, mathshape=rm, fontdir=kthpq-files/fonts/Figtree/]{kthpq}
